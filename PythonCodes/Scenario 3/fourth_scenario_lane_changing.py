...
sim_tim = 1000
t0 = 0;
x0 = np.array([[-3.0], [0.0], [0.0], [-3.0], [0.5], [0.0], [-3.0], [1.0], [0.0], [-3.0], [+1.5], [0.0]])
#
Xr1 = np.array([[-3.0], [+0.0], [0.0]])
Xr2 = np.array([[-3.0], [+0.5], [0.0]])                                                            # initial condition.
Xr3 = np.array([[-3.0], [+1.0], [0.0]])                                                            # initial condition.
Xr4 = np.array([[-3.0], [+1.5], [0.0]])                                                            # initial condition.
...
while (not rospy.is_shutdown()):
 # and (mpciter < sim_tim / T)
    ...
    for k in range(N):
        ...
        # Straight Line
        if t_predict <= 10.0:
            x_ref1 = -3.0 + 0.15*t_predict; y_ref1 = 0.0; theta_ref1 = 0.0; xdot_ref1 = 0.15; ydot_ref1 = 0.0
            v_ref1 = np.sqrt(np.power(xdot_ref1,2)+np.power(ydot_ref1,2)); omega_ref1 = 0.0
            #
            x_ref2 = -3.0 + 0.15*t_predict; y_ref2 = 0.5; theta_ref2 = 0.0; xdot_ref2 = 0.15; ydot_ref2 = 0.0
            ...
            #
            x_ref4 = -3.0 + 0.15*t_predict; y_ref4 = +1.5; theta_ref4 = 0.0; xdot_ref4 = 0.15; ydot_ref4 = 0.0
